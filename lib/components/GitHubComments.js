...
export default function GitHubComments({ issue }) {
  ...
  return (
    <div className="pb-6">
      <h2 className="text-center font-display-sc lowercase tracking-tight text-sc pt-5 border-t border-ink">
        Comments
      </h2>
          ...
          >
            ...
            >
              <Image
                ...
                alt={`Profile picture for GitHub user ${comment.user.login}.`}
              />
              <div className="flex flex-row justify-between w-full px-3 items-center">
                ...
                <a
                  ...
                  className="text-ink/60 italic text-side hover:underline"
                >
                  {date.toDateString()}
                </a>
              </div>
