...
My goal was to write a "bloom" type tag where all voices<span id="more-403"></span> start on a single unison note, and travel in smooth contrary motion to the final chord. Some great examples of this kind of tag are <a href="{{ site.url }}/blog/barbershop-multi-track-cry/">Cry</a> and <a href="{{ site.url }}/blog/tag-sleepy-time-down-south/">Sleepy Time</a>. I took this idea so it's logical extreme by using almost entirely chromatic contrary motion. In fact, of the melodic intervals in the tag, 19 are half steps, 9 are whole steps and 2 are perfect fourths.
