...
A little over a year ago, I was reading through the source code of [Underscore.js](http://underscorejs.org/) and noticed two methods that looked awfully similar. Knowing that Underscore was actively trying to [shave off some weight](https://github.com/jashkenas/underscore/issues/2060), I thought I'd try to combine them.

Many hours later, I had a working solution which combined the two ten-line functions into a single twelve-line factory function. Smugly pleased with my cleverness, I went to measure how these few shaved lines would affect the total size of the library.
